            ...
            <div className="card">
              <div className="card-body">
                <div className="row icons-list">
                  ...
                  <div className="col-sm-6 col-md-4 col-lg-3">
                    <i className="mdi mdi-account-settings-variant" /> mdi mdi-account-settings-variant
                  </div>
                  <div className="col-sm-6 col-md-4 col-lg-3">
                  ...
                  <div className="col-sm-6 col-md-4 col-lg-3">
                    <i className="mdi mdi-Majestic" /> mdi mdi-Majestic
                  </div>
                  <div className="col-sm-6 col-md-4 col-lg-3">
                  ...
                  <div className="col-sm-6 col-md-4 col-lg-3">
                    <i className="mdi mdi-chart-scatterplot-hexbin" /> mdi mdi-chart-scatterplot-hexbin
                  </div>
                  <div className="col-sm-6 col-md-4 col-lg-3">
                  ...
                  <div className="col-sm-6 col-md-4 col-lg-3">
                    <i className="mdi mdi-email-secure" /> mdi mdi-email-secure
                  </div>
                  <div className="col-sm-6 col-md-4 col-lg-3">
