                    ...
                    <div className="row">
                      <div className="col-md-4 d-flex align-items-center">
                        <div className="d-flex flex-row align-items-center">
                          <i className="mdi mdi-compass-outline icon-lg text-warning" />
                      ...
                      <div className="col-md-4 d-flex align-items-center">
                        <div className="d-flex flex-row align-items-center">
                          <i className="mdi mdi-compass-outline icon-md text-success" />
                          <p className="mb-0 ml-1">
                            Icon-md
                          </p>
                        </div>
                      ...
                      <div className="col-md-4 d-flex align-items-center">
                        <div className="d-flex flex-row align-items-center">
                          <i className="mdi mdi-compass-outline icon-sm text-danger" />
                          <p className="mb-0 ml-1">
                            Icon-sm
                          </p>
                        </div>
              ...
              <div className="card-body">
                ...
                <div className="row">
                  <div className="col-md-6">
                    <address>
                      <p className="font-weight-bold">Majestic inc.</p>
                      <p>
                        695 lsom Ave,
                      </p>
                      <p>
